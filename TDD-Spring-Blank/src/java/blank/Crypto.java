...
public class Crypto {
	...
	private final static String KEY_PASSWORD = "968AD25B96915DD9267110A56E37D838";
	
	public static String encryptPassword(String src) throws GeneralSecurityException {
		return encrypt(src, KEY_PASSWORD);
	}
